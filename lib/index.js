...
exports.convertToPPTX = function (inputFileName, options) {
    ...
    // Create a temporary directory.
    // Changed so directory would not be deleted.
    var tmpDir = tmp.dirSync({unsafeCleanup: false});
    // Added console.log for name of directory
...
exports.convertToVideo = function (inputFileName, options) {
    ...
    // Commented outJoin all images to a single video
    /*resp = execSync([
        "avconv",
        // Frames per second
        "-r", 50,
